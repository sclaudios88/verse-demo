...
`;e.ShadersStore[G]||(e.ShadersStore[G]=K);var q=[T,F,R,p,m,C,k,w,h,_,t,n,u,D,N,S,V,o,c,j,E,v,b,f,y,x,i,r,a,O,M,A,W,s,l,P,d,g];for(let t of q)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var J={name:G,shader:K};export{J as openpbrVertexShader};