import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-Ct2VqHzk.js";import{n as te,t as ne}from"./fogFragment-EikOP4pH.js";import{t as re}from"./logDepthDeclaration-DYYUVTrx.js";import{n as ie,r as ae,t as n}from"./imageProcessingFunctions-DDCHCHSl.js";import{t as oe}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as se}from"./meshUboDeclaration-BATNZvmb.js";import{t as ce}from"./helperFunctions-BH8P-eyq.js";import{n as le,r as ue,t as de}from"./bumpFragment-DB-JU_0p.js";import{i as fe,n as pe,r as me,t as he}from"./reflectionFunction-DYtFqouG.js";import{t as ge}from"./pbrBRDFFunctions-DxfbxN23.js";import{t as _e}from"./harmonicsFunctions-CMr56qfT.js";import{S as ve,_ as ye,a as be,b as xe,c as Se,d as Ce,f as we,g as Te,h as Ee,i as r,l as De,m as Oe,n as ke,o as Ae,p as je,r as Me,s as Ne,t as Pe,u as Fe,v as Ie,x as Le,y as Re}from"./pbrDebug-CdA_Ee_f.js";import{t as ze}from"./mainUVVaryingDeclaration-B_7d0nc3.js";import{t as Be}from"./pbrUboDeclaration-oed3_f2e.js";var i=`samplerFragmentAlternateDeclaration`,a=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=a);var Ve={name:i,shader:a},o=`pbrFragmentSamplersDeclaration`,s=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=s);var He={name:o,shader:s},c=`decalFragment`,l=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=l);var u={name:c,shader:l},d=`pbrBlockAlbedoOpacity`,f=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var Ue={name:d,shader:f},p=`pbrBlockReflectivity`,m=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var We={name:p,shader:m},h=`pbrBlockAmbientOcclusion`,g=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var Ge={name:h,shader:g},_=`pbrBlockAlphaFresnel`,v=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var Ke={name:_,shader:v},y=`pbrBlockAnisotropic`,b=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var qe={name:y,shader:b},x=`pbrBlockReflection`,S=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var Je={name:x,shader:S},C=`pbrBlockSheen`,w=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var Ye={name:C,shader:w},T=`pbrBlockClearcoat`,E=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var D={name:T,shader:E},O=`pbrBlockIridescence`,k=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=k);var Xe={name:O,shader:k},A=`pbrBlockSubSurface`,j=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var Ze={name:A,shader:j},M=`pbrBlockNormalFinal`,N=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var Qe={name:M,shader:N},P=`pbrBlockLightmapInit`,F=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var $e={name:P,shader:F},I=`pbrBlockGeometryInfo`,L=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var et={name:I,shader:L},R=`pbrBlockReflectance`,z=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var tt={name:R,shader:z},B=`pbrBlockDirectLighting`,V=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var nt={name:B,shader:V},H=`lightFragment`,U=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var rt={name:H,shader:U},W=`pbrBlockFinalLitComponents`,G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var it={name:W,shader:G},K=`pbrBlockFinalUnlitComponents`,q=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var at={name:K,shader:q},J=`pbrBlockFinalColorComposition`,Y=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var ot={name:J,shader:Y},X=`pbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var st={name:X,shader:Z},Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var ct=[ve,Le,oe,se,Be,ze,xe,Re,fe,Ve,me,He,ie,t,re,te,Ie,ce,ye,Te,Ee,n,Oe,_e,je,we,Ce,ge,Fe,De,Se,Ne,Ae,pe,ue,le,he,u,Ue,We,Ge,Ke,qe,Je,Ye,D,Xe,Ze,ee,be,de,Qe,r,$e,et,tt,nt,rt,it,at,ot,ae,ne,Me,st,ke,Pe];for(let t of ct)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var lt={name:Q,shader:$};export{lt as pbrPixelShaderWGSL};