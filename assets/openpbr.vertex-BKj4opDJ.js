...
}`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=H);var U=[p,m,C,P,w,h,_,t,n,u,O,E,S,L,o,c,M,v,b,f,A,T,y,x,i,r,a,D,j,k,B,s,l,N,d,g];for(let t of U)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var W={name:V,shader:H};export{W as openpbrVertexShaderWGSL};