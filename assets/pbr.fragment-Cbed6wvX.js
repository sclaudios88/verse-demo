import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-DVK0wgyZ.js";import{n as te,t as ne}from"./fogFragment-CISE_m3s.js";import{t as re}from"./logDepthDeclaration-3gXGtHbI.js";import{n as ie,r as ae,t as oe}from"./imageProcessingFunctions-D4xSmiDb.js";import{t as se}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as ce}from"./meshUboDeclaration-BmNu2KU_.js";import{t as le}from"./helperFunctions-BXbvU0Ia.js";import{n as ue,r as de,t as fe}from"./bumpFragment-BrQB2GBa.js";import{i as pe,n as me,r as he,t as ge}from"./reflectionFunction-BvoxEfKw.js";import{t as _e}from"./pbrBRDFFunctions-BCNINF-p.js";import{t as ve}from"./harmonicsFunctions-QSz_WdsQ.js";import{_ as ye,a as be,b as xe,c as Se,d as Ce,f as we,g as Te,h as Ee,i as De,l as Oe,m as ke,n as Ae,o as je,p as Me,r as Ne,s as Pe,t as Fe,u as Ie,v as Le,x as Re,y as ze}from"./pbrDebug-QPvJsx1k.js";import{t as Be}from"./mainUVVaryingDeclaration-BBamQlxR.js";import{t as Ve}from"./pbrUboDeclaration--xFZEw0i.js";var n=`pbrFragmentDeclaration`,r=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=r);var He={name:n,shader:r},i=`samplerFragmentAlternateDeclaration`,a=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var Ue={name:i,shader:a},o=`pbrFragmentSamplersDeclaration`,s=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=s);var We={name:o,shader:s},c=`decalFragment`,l=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=l);var Ge={name:c,shader:l},u=`pbrBlockAlbedoOpacity`,d=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=d);var Ke={name:u,shader:d},f=`pbrBlockReflectivity`,p=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=p);var qe={name:f,shader:p},m=`pbrBlockAmbientOcclusion`,h=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=h);var Je={name:m,shader:h},g=`pbrBlockAlphaFresnel`,_=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var Ye={name:g,shader:_},v=`pbrBlockAnisotropic`,y=`#ifdef ANISOTROPIC
...
return outParams;}
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var tt={name:O,shader:k},A=`clusteredLightingFunctions`,j=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var nt={name:A,shader:j},M=`pbrBlockReflectance0`,N=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=N);var rt={name:M,shader:N},P=`pbrClusteredLightingFunctions`,F=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var it={name:P,shader:F},I=`pbrBlockNormalFinal`,L=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var at={name:I,shader:L},R=`pbrBlockLightmapInit`,z=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var ot={name:R,shader:z},B=`pbrBlockGeometryInfo`,V=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var st={name:B,shader:V},H=`pbrBlockReflectance`,U=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=U);var ct={name:H,shader:U},W=`pbrBlockDirectLighting`,G=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=G);var lt={name:W,shader:G},K=`lightFragment`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=q);var ut={name:K,shader:q},J=`pbrBlockFinalLitComponents`,dt=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=dt);var ft={name:J,shader:dt},Y=`pbrBlockFinalUnlitComponents`,pt=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=pt);var mt={name:Y,shader:pt},X=`pbrBlockFinalColorComposition`,ht=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=ht);var gt={name:X,shader:ht},Z=`pbrBlockPrePass`,_t=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=_t);var vt={name:Z,shader:_t},Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var yt=[Re,xe,ze,He,se,ce,Ve,Be,Le,ye,Te,pe,Ue,he,We,ie,t,re,te,Ee,le,ke,Me,we,oe,Ce,ve,Ie,Oe,Se,_e,Pe,je,me,de,ue,ge,Ge,Ke,qe,Je,Ye,Xe,Ze,Qe,$e,et,tt,nt,rt,it,ee,be,fe,at,De,ot,st,ct,lt,ut,ft,mt,gt,ae,ne,Ne,vt,Ae,Fe];for(let t of yt)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var bt={name:Q,shader:$};export{bt as pbrPixelShader};