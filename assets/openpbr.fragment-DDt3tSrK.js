import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-DVK0wgyZ.js";import{n as te,t as ne}from"./fogFragment-CISE_m3s.js";import{t as n}from"./logDepthDeclaration-3gXGtHbI.js";import{n as r,r as i,t as re}from"./imageProcessingFunctions-D4xSmiDb.js";import{t as ie}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as ae}from"./meshUboDeclaration-BmNu2KU_.js";import{t as oe}from"./helperFunctions-BXbvU0Ia.js";import{i as se,n as ce,r as le,t as ue}from"./reflectionFunction-BvoxEfKw.js";import{a as de,i as fe,n as pe,o as me,r as he,t as ge}from"./openpbrTransmissionLayerData-DUOGptPd.js";import{t as _e}from"./pbrBRDFFunctions-BCNINF-p.js";import{t as ve}from"./harmonicsFunctions-QSz_WdsQ.js";import{_ as ye,a,b as o,c as s,d as be,f as xe,g as Se,h as Ce,i as we,l as Te,m as Ee,n as De,o as Oe,p as ke,r as Ae,s as je,t as Me,u as Ne,v as Pe,x as Fe,y as c}from"./pbrDebug-QPvJsx1k.js";import{t as l}from"./openpbrUboDeclaration-CbPGRvOI.js";import{t as u}from"./mainUVVaryingDeclaration-BBamQlxR.js";var d=`openpbrFragmentDeclaration`,f=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vSubsurfaceWeight;uniform vec3 vSubsurfaceColor;uniform float vSubsurfaceRadius;uniform vec3 vSubsurfaceRadiusScale;uniform float vSubsurfaceScatterAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform float vGeometryThinWalled;uniform vec4 vLightingIntensity;uniform float visibility;uniform vec2 renderTargetSize;
#ifdef BASE_COLOR
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var Qe=[Fe,o,me,c,p,ie,ae,l,u,Pe,ye,Se,se,le,g,r,t,n,te,Ce,oe,Ee,ke,xe,re,be,ve,Ne,Te,s,_e,je,Oe,ce,Ie,Le,ue,de,Re,ze,fe,he,Be,ee,a,k,Ve,He,ge,pe,Ue,We,Ge,Ke,we,qe,Je,Ye,Xe,i,ne,Ae,Ze,De,Me];for(let t of Qe)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var $e={name:Q,shader:$};export{$e as openpbrPixelShader};